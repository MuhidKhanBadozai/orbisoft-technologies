        ...
        <div className='page' id='contact'>
            <div className='w-screen contact-bg before:block after:block min-h-screen overflow-hidden flex flex-col justify-end items-center gap-y-4 relative z-[2]'>
                ...
                <div className='flex flex-col items-center mt-[5vh]' style={{ opacity: '1', transform: 'none' }}>
                    <p className="poppins-regular text-3xl">Orbisoft</p>
                    <p className="poppins-extralight text-3xl font-light">Technologies</p>
                    <p className="text-gray-500 text-xl px-4 tracking-[calc(-1rem*0.03)] mt-[8vh] select-none mb-1 text-center">© OrbiSoft Technologies 2020. All rights reserved.</p>
                    <p className="text-gray-500 text-xl px-4 select-none tracking-[calc(-1rem*0.03)] mb-8 max-w-[500px] text-center">This site showcases our personal projects and professional work. Content may not be used without permission.</p>
                </div>
            </div>
        </div>
    );
